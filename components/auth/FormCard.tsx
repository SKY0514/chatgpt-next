...
const FormCard = ({ title, subtitle, footer, children }: Props) => {
  return (
    <div className="relative w-115">
      ...
      />
      <Card className="relative flex w-full flex-col items-center gap-6 rounded-2xl p-10 has-data-[slot=card-footer]:pb-10 shadow-[0px_20px_25px_-5px_rgba(210,217,244,0.4),0px_8px_10px_-6px_rgba(210,217,244,0.4)] ring-0">
